...
const DynamicButton = ({
  ...
  return (
    <div className="">
      ...
      >
        <div
          className={`absolute h-[40px] ${width} cursor-pointer items-center overflow-hidden rounded-xl bg-gradient-to-br  from-red-400 to-red-600 shadow-2xl transition duration-1000 ease-out hover:scale-x-110 hover:scale-y-105`}
        ></div>
